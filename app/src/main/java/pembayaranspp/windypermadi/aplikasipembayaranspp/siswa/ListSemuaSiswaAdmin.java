...
import pembayaranspp.windypermadi.aplikasipembayaranspp.model.SiswaModel;
...
public class ListSemuaSiswaAdmin extends AppCompatActivity {
    ...
    List<pembayaranspp.windypermadi.aplikasipembayaranspp.model.SiswaModel> SiswaModel;
